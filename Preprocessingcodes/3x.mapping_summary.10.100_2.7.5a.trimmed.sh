...
echo -e 'File\t# reads\t% uniquely mapped\t# of splices\t% mismatch rate per base\t% deletion rate per base\t% insertion rate per base\t% reads mapped to multiple loci\t% reads unmapped' > mapping_to_rhesus10100_trimmed_summary.txt
...
do
    ...
    echo -e ''$item'\t'${OUTPUT1}'\t'${OUTPUT2}'\t'${OUTPUT3}'\t'${OUTPUT4}'\t'${OUTPUT5}'\t'${OUTPUT6}'\t'${OUTPUT12}'\t'${OUTPUT13}'\t' >> mapping_to_rhesus10100_trimmed_summary.txt
